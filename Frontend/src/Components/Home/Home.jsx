        ...
        <div className="w-5/6 mx-auto mt-4 mb-14 cursor-pointer gap-6 flex justify-between">
          ...
          <div className="w-full mx-auto lg:grow h-[290px] bg-black">
            <div className="flex bg-black w-full h-full">
              <div className="hidden md:block w-2/5 mx-auto h-full  bg-black">
                <div className="my-8 flex justify-start text-white items-center gap-3">
                  ...
                  <p className="font-poppins text-[#fafafa]">
                    Iphone 14 series
                  </p>
                </div>
                <p className="font-inter text-5xl font-semibold pb-6 text-[#fafafa]">
                  Up to 10% off voucher
                </p>
                <div className="flex justify-start text-[#fafafa] items-center">
                  <p className="text-poppins font-medium underline underline-offset-4">
                    Shop Now
                  </p>
            ...
            <div className="flex justify-center pb-2 gap-2 bg-black items-center">
              <button
                onClick={nextSlide}
                className="w-[10px] h-[10px] bg-white opacity-50 focus:bg-red-400 cursor-pointer rounded-full border-2"
              ></button>
              <button
                onClick={nextSlide}
                className="w-[10px] h-[10px] bg-white opacity-50 focus:bg-red-400 cursor-pointer rounded-full border-2"
